...
def run_selftest() -> int:
    ...
    try:
        ...
        mp_hi = _mp13("2026-07-16", target_dollars=650.0, prior_vix=19.0, overnight_gap=100.0)
        ...
        mp_lo = _mp13("2026-07-16", target_dollars=150.0, prior_vix=16.0, overnight_gap=100.0)
        ...
        mp_rnd = _mp13("2026-07-16", target_dollars=200.0, prior_vix=16.0, overnight_gap=100.0)
        ...
        mp_cap = _mp13("2026-07-16", target_dollars=2000.0, prior_vix=16.0, overnight_gap=100.0)
