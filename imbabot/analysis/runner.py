...
# The k-NN Morning-Plan model (OHLCV) was removed in favor of the tick-data engine
# (see tick_runner.py). The older single-spread daily recommender below is retained.
def run_daily(
    symbol: str,
    *,
